...
impl Config {
    ...
    pub fn from_args() -> Config {
        ...
        let default_daemon_rpc_port = match config.network {
            ...
            Network::Signet | Network::CSignet => 38332,
        };
        let default_daemon_p2p_port = match config.network {
            Network::Bitcoin => 8333,
            Network::Testnet => 18333,
            Network::Regtest => 18444,
            Network::Signet | Network::CSignet => 38333,
        };
        ...
        match config.network {
            ...
            Network::Signet | Network::CSignet => config.daemon_dir.push("signet"),
        }
